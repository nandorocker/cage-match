// This file is auto-generated from the cage_movies.json file
...
export const movies: Movie[] = [
  {
    "ranking": 1,
    "tier": 1,
    "tier_description": "The 25 Most Essential Cage Movies",
    "title": "Face/Off",
    "year": 1997,
    "description": "In Face/Off, John Travolta plays Sean Archer, an FBI agent hunting a terrorist, Castor Troy (Nicolas Cage) who killed Archer’s son in an assassination attempt on Archer. Early in the movie, Troy ends up in a coma, but has planted an explosive device hidden in Los Angeles. To try and discover the secret location, Archer undergoes a procedure wherein Archer’s face is removed and Troy’s face is attached, becoming Castor Troy. Of course, later Archer’s face is attached to Troy. How can such a strange premise for a movie result in one of the best action movies of all time and my personal favorite Nicolas Cage movie? I could write an essay on the merits of Face/Off, but I will try and keep it as concise as possible. For starters, the acting is shockingly good. The first third of the movie develops the Castor Troy and Sean Archer characters so well and then flips them such that you get to watch Travolta playing Cage’s Troy and Cage playing Travolta’s Archer. Both of them nail it, not only recreating the already established mannerisms of the characters but also recreating the other actor’s eccentricities. Particularly for this type of action movie where acting sometimes takes a backseat, both actors show that they are geniuses in their prime. Moreover, John Woo’s direction leads to a briskly paced 139 minutes. Whether it is the characters or the camera, it feels like something is moving in every shot, making even purely dialog scenes exciting. These combine to make Face/Off the perfect conclusion to the Beige Volvo trilogy. Sure, the premise is hilarious in concept but they somehow nail the landing in execution. The action sequences are neatly spaced throughout the film and are well-done and engaging, with thrilling moments that will have you on edge. Plus, Face/Off is littered with iconic and hilarious moments, such as the “take his face off”/“no more drugs for that man” scene, Cage dancing around in priest garb to Handel's Messiah, and the creepy “eat a peach for hours” scene. But the main reason why this movie lands at number one on this list: This is the ultimate Nicolas Cage movie in terms of sheer entertainment. He is over-the-top and unconventional, while at the same time showing nuanced acting skills. This leads this to be one of the more highly memed Cage movies while maintaining a level of quality that transcends the memes. It is simply the most enjoyable and rewatchable Cage movie. TAGS: Nicolas Cage Movies Ranked; Nicolas Cage Films Ranked; Nicolas Cage Film Ranking; Nicolas Cage Movie Ranking; Nicolas Cage Movie Reviews"
  },
  {
    "ranking": 2,
    "tier": 1,
    ...
    "title": "Pig",
    "year": 2021,
    "description": "In Pig, Cage plays a recluse living in the Oregon forests with his truffle-hunting pig, until his Pig is stolen forcing him to return to Portland and confront his previous life. If you have not seen Pig, do not look up anything else about this movie: Just watch it and experience it going in as blind as possible. Of Nicolas Cage’s 97+ films, I believe that his turn in Pig is his very best acting performance. Every silent emotion, every line of dialogue, and every other thing he conveys is a masterclass. You deeply feel what his character feels and if you are not sharing tears with Cage multiple times, you likely were not paying attention. Even with his distinctive style and that face you have seen thousands of times, it is easy to forget this is Cage. One of the biggest Oscar snubs ever was not even nominating Nicolas Cage for Best Actor for Pig. While Pig is such a stunning success because of an all-time Cage performance, the rest of the movie is a moving story about loss and the power of shared experience, in particular, meals. This is the directorial debut of Michael Sarnoski and he absolutely nails every aspect of this story (which was also co-written by Sarnoski). The melancholic atmosphere throughout is expertly molded by beautiful shadowy shots of Oregon’s forests and cloudy Portland. This movie is a modern day masterpiece that should be required viewing by anyone who likes movies or considers themselves a foodie."
  },
  {
    "ranking": 3,
    "tier": 1,
    ...
    "year": 1987,
    "description": "I love almost every movie the Coen Brothers have directed, and Raising Arizona is unsurprisingly high-up on that list. This crime comedy stars Nicolas Cage as an ex-convict married to a former police officer (Holly Hunter) who cannot have children, so they steal one of the quintuplets from a regional celebrity furniture salesman. Add in a mix of fantasy and action and this movie really shines. Raising Arizona was the Coen Brothers second movie they wrote and directed, and their first of many comedies (such as The Big Lebowski and O Brother, Where Art Thou?). At the time he was cast, Cage was an up-and-coming actor, but this was before he became more well known with the success of Moonstruck. Thus, Raising Arizona is a fascinating early showcase of one of the best modern-day writer-director duos first delving into comedy featuring one of the best living actors still at the time honing his craft. The results could not be better. While much of the humor is situational, Cage nonetheless rises to the occasion by delivering some truly funny and absurd lines. If you ever wanted to cackle at an outlandish diaper heist scene, look no further than Raising Arizona. Admittedly, as with many Coen Brothers movies, the humor is not for everyone. But if it is your style, this is bound to be one of your favorites, and it remains a must-watch Cage classic."
  },
  {
    "ranking": 4,
    "tier": 1,
    ...
    "title": "Adaptation",
    "year": 2002,
    "description": "Speaking of meta comedies featuring Nicolas Cage playing two characters at the same time . . . Adaptation is a movie written by Charlie Kaufman and tells the story of Charlie Kaufman and his fictitious brother Donald Kaufman (both played by Nicolas Cage) as Charlie struggles to adapt the book, The Orchid Thief. Interspersed and intersecting with the Kaufman brothers’ trials and tribulations is the actual story from The Orchid Thief book, with Meryl Streep playing a fictitious iteration of real-life author Susan Orlean as she is interviewing and spending time with John Laroche, a plant-dealer and orchid thief played by Chris Cooper. As one would hope with a movie about a screenplay writer writing a screenplay, the script is brilliant. At times laugh-out-loud funny with tender and dramatic moments, Kaufman manages to show off his skills as a screenwriter through satirizing himself as a screenwriter. It is further bolstered by true powerhouse acting performances. Cooper deservedly won the Academy Award for Best Supporting Actor while Cage was nominated for Best Actor and Streep was nominated for Best Supporting Actress. Also, fun fact: The screenplay was credited to both Charlie Kaufman and Donald Kaufman, and when it received an Oscar nomination for Best Adapted Screenplay (which is should have won,) Donald Kaufman became the first truly fictitious Oscar nominee (i.e., not a name that was a cover for a real person.) Focusing on Cage, this is up there with his greatest performances. It is impressive that he is able to encapsulate both neurotic and nervous Charlie and gregarious and sweet Donald. But it is even more impressive that he is able to make these characters interact so seamlessly throughout the movie."
  },
  {
    "ranking": 5,
    "tier": 1,
  ...
  },
  {
    ...
    "year": 2004,
    "description": "There are people who swear by A Christmas Story, How the Grinch Stole Christmas, and/or Christmas Vacation for Christmas. There are people who cannot decide if Nightmare Before Christmas is a Christmas movie or a Halloween movie so they watch it on both to be safe. There are numerous other holiday traditions centered on a variety of films. As for me, for at least 11 years, I have convinced my family, friends, colleagues, and anyone in my orbit to watch National Treasure on the Fourth of July. While I remember some American history from high school, much of my knowledge comes from this movie. National Treasure is a near perfect Nicolas Cage film simply because an intelligent treasure-quest style film is well-suited for Cage, melding his action hero roles with his indie drama personas. His Benjamin Franklin Gates character is uniquely suave, brilliant, cocky, and sophisticated, yet has a side of him that is silly and nerdy. Oh, and like Cage himself, Gates is very interested in acquiring treasure (see, e.g., Nicolas Cage outbidding Leonardo DiCaprio for a dinosaur skull.) Outside of Cage, this movie is fast-paced and clever, with action neatly intersecting the underlying mystery and the more subdued clue discovery scenes. Sure, there are more critically acclaimed Cage movies out there and there are better Cage performances, but National Treasure is a damned-near magnum opus if entertainment is what you seek. Plus it is important in the Cage cannon as it is (sadly) the beginning-and-end of many casual Cage viewers repertoire. You can always hook them in talking about National Treasure and then show them the next 7 movies . . . (followed by the previous 82)."
  },
  {
    "ranking": 9,
    "tier": 1,
    ...
    "year": 1995,
    "description": "Since March 25, 1996, every movie that Nicolas Cage has appeared in has dropped the line “Academy Award Winner Nicolas Cage” (or some paraphrase) in at least one piece of marketing material. Thus, it seems crazy to have Cage’s only Oscar winning performance as low as 9, but that is just how good Cage is! (Plus, in my opinion he should have won at least a couple more since then). Leaving Las Vegas is one of those movies that I recommend everyone watch once, but not necessarily more than once because it is quite sad and frequently hard to watch. It features some all-time great performances by Cage and Elisabeth Shue (who should have won Best Actress to pair with Cage’s victory). As a brief overview, it is based on a semi-autobiographical novel with Cage playing an alcoholic screenwriter who goes to Las Vegas to drink himself to death, and in the process meets Sera (Shue,) a prostitute working for an abusive pimp. The author of the book, John O’Brien, sadly committed suicide after signing away the film rights to the novel. On the surface, this is sad story about broken people finding each other, but as you peel back the layers this is a movie about compassion, acceptance, and love. While it is a top-tier film anyway you shake it, Cage’s and Shue’s performances really elevate this movie to the stratosphere of all-time dark indie dramas."
  },
  {
    "ranking": 10,
    "tier": 1,
    ...
    "title": "Kiss of Death",
    "year": 1995,
    "description": "If you know anything about Nicolas Cage, you likely know of (or at least have heard of) the next 9 movies on this list, leaving Kiss of Death as the wild card in the top 10. To be honest, that makes sense, as this is the highest ranked movie where Cage is not the central player. And to be fair, Kiss of Death is a pretty random 90s crime thriller that was not a financial success, despite its excellent cast. That said, I would be hard pressed to find a movie where I enjoyed each pivotal character as much as I do in Kiss of Death. To begin with Nicolas Cage, he plays a psychotic mobster named Little Junior Brown, who bench-presses strippers at his family-owned strip club (named \"Baby Cakes\"), is obsessed with acronyms thus giving himself the acronym B.A.D. (\"Balls, Attitude, Direction\"), and who was in prison but ate with his hands because he does not like the taste of metal in his mouth. Little Junior Brown is one of the weirdest yet best Cage roles, a real 10/10 on Cageiness. Next is Ving Rhames, the gangster with great lines such as: “Red is my bad luck color. I ain’t got nothing to do with red.” Let us not forget Samuel L. Jackson, a detective who is grazed by a bullet in an early scene causing him to have an eye issue and leading him to be constantly wiping away tears with an angry scowl only Jackson could maintain. This of course ignores our lead performance, with David Caruso giving some of the most over-the-top 90s action “reformed criminal but back in crime to help the good guys” script reads you’ve ever heard in a movie (he did get a Razzie nomination for this and other films that year, but the supporting roles really save his performance.) There are also memorable turns by Helen Hunt, Stanley Tucci, Kathryn Erbe, and Michael Rapaport. All this to say that Kiss of Death is all over the map in terms of acting and storytelling, but it is the type of enjoyable chaos that benefits from Cage and features one of my favorite Cage performances. Plus, this strange cast of characters thrust together haphazardly somehow still forms the perfect jigsaw puzzle of action, comedy, and crime, with the end result being a excellent forgotten gem of the 90s."
  },
  {
    "ranking": 11,
    "tier": 1,
    ...
    "year": 1989,
    "description": "For those of you who have followed my Nicolas Cage journey, you will know in the last 10 years this movie has been ranked high as #3 and as low as # 30. It is a difficult egg to crack. Vampire’s Kiss is one of the most memed Cage roles. And fair enough: He gets weird with this one. He yells the ABCs at his therapist, he wears vampire teeth and runs around screaming about being a vampire, his cries are overdramatic “boo hoos,” and he makes the famous expression from the “YOU DON’T SAY” Cage meme template. Cage really goes all out on the method acting here, including actually eating multiple cockroaches during the performance. As for the movie itself, it is a very dark comedy about a man who becomes convinced he is a vampire and puts a blowtorch to his personal and professional life based on his convictions. There are intentionally funny moments, unintentionally funny moments, and a lot of uncomfortable moments. But through it all, and despite the scenes you may see in a meme or a Cage compilation, this is an inspired performance with a lot to like. This may not be your favorite movie, but you will be so entertained by the strangeness of it all. It is the type of Cage movie to make you stop and scream: THIS IS ART!"
  },
  {
    "ranking": 12,
    "tier": 1,
  ...
  },
  {
    ...
    "title": "Con Air",
    "year": 1997,
    "description": "Con Air, the middle entry in the Beige Volvo trilogy, is everything you want in a 90s action movie: (1) Excellent setup where you can predict exactly what is about to happen? Check: Nicolas Cage plays a former Army Ranger being released from prison who has to be transported on a plane full of the most notorious and dangerous convicts with mostly unarmed guards. (2) Outlandish and over-the-top characters? Check: John Malkovich, Steve Buscemi, Dave Chappelle, Ving Rhames, and, of course, Cage each bring so much eccentricity to their characters. (3) Absurd action sequences with unfathomable amounts of property destruction?  Check: Without spoilers, the ending thirty minutes is unbelievable. (4) Absolute banger of country ballad appearing over multiple emotional scenes? Check: HOW DO I LIVE WITHOUT YOU, I WANT TO KNOW! You will probably laugh, you may or may not be on the edge of your seat, but you would be hard-pressed not to have a great time. As one final note: It would be an injustice not to mention Cage’s hair and accent, both of which are some of the most iconic (and most memed) parts of his illustrious career. Hilarious out of context and still amusing in context, once you’ve experienced Con Air, it is just hard to “put the bunny back in the box.”"
  },
  {
    "ranking": 14,
    "tier": 1,
  ...
  },
  {
    ...
    "title": "Red Rock West",
    "year": 1995,
    "description": "Following his Academy Award win for the 1995 film Leaving Las Vegas, Nicolas Cage had a long run of mainly appearing in Hollywood blockbusters. But in the years before that, Cage appeared in some magnificent smaller movies, including Red Rock West. This neo-noir contemporary Western features Cage as an ex-Marine drifter who is mistaken by a small-town bar owner as a hitman the bar owner had hired to kill his wife. When Cage pretends to be the hitman and takes the money but warns the wife instead of killing her, it gets him tangled in a wild web with the actual hitman and the bar owner, who it turns out is also the local sheriff. This movie perfectly finds the balance of being a slow-burn while maintaining an excellent and engaging pace. The great acting and well-written characters throughout amplifies this, resulting in this hidden 90s gem."
  },
  {
    "ranking": 16,
    "tier": 1,
    ...
    "title": "The Rock",
    "year": 1996,
    "description": "The Rock is the first entry in the greatest unofficial trilogy of all time (The Rock, Con Air, and Face/Off,) which (as discussed below) has been dubbed the “Beige Volvo” trilogy. In this action-thriller, a group of rogue marines (led by Ed Harris) steal rockets filled with a potent chemical weapon and threaten to attack San Francisco after taking control of the famous Alcatrez prison. Nicolas Cage plays an FBI chemical weapons specialist who teams up with the only man to escape Alcatrez (Sean Connery) to sneak into Alcatrez and render the rockets ineffective. The background of Connery’s character being a former British secret agent have led to great fan theories tying this to his James Bond portrayal. This is one of the best Cage action movies. It has a great concept, quality acting, fast-paced dialog with some tremendous one-liners, and dynamite action scenes. Plus, even though it is only Michael Bay’s second film, it already contains many of the techniques he would continue to develop and use over the years (including some absolutely absurd explosions during a car chase scene). Add to that the fact that Quentin Tarantino and Aaron Sorkin were allegedly uncredited script doctors and it makes sense that this is a shining example of what a 90s action film could be. Plus, in his first post-Academy Award role, Cage brings a lot to what could have just been a run-of-the-mill non-field agent thrust into the field hero character. As a quick aside, multiple online forums have tied together The Rock, Con Air, and Face/Off as the “Beige Volvo Trilogy”. These three action blockbusters came out in 1996 and 1997 and all starred Nicolas Cage. As for the name, in the Rock, Cage’s character says in a speech about just being a biochemist with an uneventful life that he drives “a Volvo, a beige one.” In Con Air, a character is thrown out of the plane before landing on a beige Volvo. Lastly, in Face/Off, when escaping from prison, Cage steals a beige Volvo, completing the trilogy. Thus, an unofficial trilogy centered around Swedish cars and Nicolas Cage is born."
  },
  {
    "ranking": 17,
    "tier": 1,
    ...
    "year": 1999,
    "description": "Frank Pierce is one of Nicolas Cage’s most haunting performances. In a severely underrated Martin Scorsese movie, Cage plays a paramedic struggling with depression, burnout, and seeing ghosts since he was unable to save a homeless teenage girl, leaving him in a funk of being unable to save a patient for months. The structure of this movie is tremendous, mostly telling the story through three different nights of Cage’s character riding along with vastly different partners: a food-motivated John Goodman, an enthusiastically religious Ving Rhames, and a violent and cruel Tom Sizemore. Intertwined with all of this is a stellar performance opposite Cage by his then wife (although already separated at the time) Patricia Arquette, who plays a recovering addict and the estranged daughter of one of Cage’s patients. Bringing Out the Dead is one of the most difficult Cage movies to watch, rapidly changing between high intensity medical emergencies to sorrowful and despondent conversations, though Scorsese does manage to sneak in a bit of humor to lighten it in places. But as is to be expected in a movie about EMTs, death follows the characters everywhere and is a looming presence in every scene. Yet, underneath all the sadness and gloom is a beautiful and moving story about compassion. Cage has noted in interviews that Bringing Out the Dead might be the best movie he ever made."
  },
  {
    "ranking": 18,
    "tier": 1,
  ...
  },
  {
    ...
    "title": "Valley Girl",
    "year": null,
    "description": "Ah, the first time the name Nicolas Cage graced the silver screen. Valley Girl is a comedic look into 1980s life as a teenager in Los Angeles, with bitchin’ slang and some tripendicular haircuts. The soundtrack is also a fantastic snapshot of the early 1980s that is not to be missed, with songs by artists like Sparks, Men at Work, and Culture Club. Don’t forget Modern English’s song “I Melt with You”, which is so great it is played multiple times in the movie. As for Cage, he comes out of the gate swinging and is hilarious, goofy, and suave. While I am clearly biased, he is iconic from his very first scene. Regardless of your opinion on the greatness of Cage, do not miss this sometimes overlooked but essential 1980s teen comedy."
  },
  {
    "ranking": 25,
    "tier": 1,
    ...
    "year": null,
    "description": "In this Ridley Scott black comedy, Nicolas Cage plays a con artist with multiple neurological and behavioral disorders who meets his 14-year-old daughter (Alison Lohman) for the first time in the middle of trying to pull off a rare long con with his partner (Sam Rockwell). Matchstick Men is excellent, with heartfelt moments, some truly funny scenes, and a few excellent twists you are unlikely to see coming. To me, this is one of Cage’s best acting performances. He nails all aspects of his character, from a man struggling with his disorders to a sleezy con artist to a sentimental father, with a few noteworthy Cage freakouts mixed in for good measure (including a fan favorite, where Cage cuts in line at the pharmacy and in response to a sarcastic “Hey buddy, ever heard of a line?” he screams “Hey, have you ever been dragged to the sidewalk and beaten till you . . . PISSED BLOOD!”)"
  },
  {
    "ranking": 26,
    "tier": 2,
    "tier_description": "Excellent Cage Movies",
    "title": "Willy's Wonderland",
    "year": null,
    "description": "It is amazing that a movie where Nicolas Cage does not speak could be so high on a ranking of Cage movies. Lo and behold, Cage manages to do an astonishing amount with this silent and nameless Janitor character. On one hand, he makes the character hilarious in his dedication to the mission of cleaning an abandoned family entertainment center yet regimented in his strict routine of sticking to hourly breaks. On the other hand, he makes the character an unparalleled badass as he destroys rogue animatronic characters to try and save a group of teenagers. Prepare for lots of laughs interspersed with some quality Cage action and a bit of horror, though most of the frights are played for jokes."
  },
  {
    "ranking": 27,
    "tier": 2,
  ...
  },
  {
    ...
    "title": "Birdy",
    "year": null,
    "description": "Birdy is a story about two friends who serve in the Vietnam War, showing both their pre-war and post-service interactions. This movie features excellent early performances from both Nicolas Cage and Matthew Modine, as well as an outstanding score by Peter Gabriel. The end result is a well-made look at mental health and postwar trauma bolstered by a moving story of friendship. Oh and birds, birds are definitely a prominent theme."
  },
  {
    "ranking": 35,
    "tier": 2,
    ...
    "year": null,
    "description": "This movie is ridiculous from start to finish in the best ways. Nicolas Cage plays a private investigator who is going to marry his girlfriend (Sarah Jessica Parker) in Las Vegas, but when he is conned in a card game by a professional gambler (the late, great James Caan), he agrees to let the gambler spend the weekend with his girlfriend to erase the debt. This absurd plot setup leads to a romantic screwball comedy filled with hilarious moments and many non-believable yet amusing situations. Despite rarely exploring the genre, Cage has a knack for comedy, and was even (rightfully) nominated for Best Actor in a Comedy at the Golden Globes for Honeymoon in Vegas. Make sure to stick around to the end for Cage to showcase some of his Elvis fandom."
  },
  {
    "ranking": 36,
    "tier": 2,
  ...
  },
  {
    ...
    "year": null,
    "description": "Nicolas Cage is an otherworldly being, and in City of Angels, he plays an angel who falls in love with a doctor and must decide whether to become human to be with her or remain an angel. Equal parts sappy and sad, this movie is much better than one may expect, successfully elevating a formulaic romantic drama to raise deeper questions. Cage opposite Meg Ryan in a romantic 1990s movie just shows what a superstar he was at the time, and he certainly helps upgrade this movie. Have the tissues ready."
  },
  {
    "ranking": 48,
    "tier": 3,
    ...
    "year": null,
    "description": "Butcher’s Crossing is a beautifully shot western featuring an excellent performance from Nicolas Cage. It tells the story of a Harvard dropout teaming up with an intense and experienced buffalo hunter (Cage) as part of a ragtag team that finds and successfully hunts a huge buffalo herd, but becomes trapped over winter in the snowy Colorado wilderness. It meanders at times, but Cage brings it back in focus and ties it all together, resulting in an intense movie about obsession and its consequences à la Moby Dick in the mountains."
  },
  {
    "ranking": 49,
    "tier": 4,
    "tier_description": "Good Cage Movies",
    "title": "The Wicker Man",
    "year": null,
    "description": "Sometimes you like Nicolas Cage movies because they are great movies, sometimes you like them because he gives an amazing performance that elevates the rest of the film, and sometimes you just like them because they are hilariously ridiculous. To be clear: The Wicker Man is not the 49th best movie Cage has been in based on quality, but it is just too iconic and so-bad-its-good funny to drop any lower. It is hard to pick a favorite Cage scene, between the “how’d it get burned?!” freakout, Cage walking into an inn and just decking a random lady casually with little-to-no explanation, Cage dressed as a bear and getting a running head start to punch a woman as she asks “what is wrong sister,” and of course the infamous “NOT THE BEES” scene. My personal favorite is when Cage, a police officer investigating the disappearance of his daughter, shows up on the island and is greeted by a group of people holding a nefarious looking bag. He asks, “what’s in the bag, a shark or something?” and then tries to look, but the people jerk the bag when he gets close to make him jump back from the bag. He never investigates or questions this further. It is a top-tier hilariously bad movie and if you have somehow not yet experienced it, I highly recommend a viewing."
  },
  {
    "ranking": 50,
    "tier": 4,
  ...
  },
  {
    ...
    "year": null,
    "description": "This is a big-budget, 2+-hour wartime romance based on a 1990s novel and directed by the man who brought you Shakespeare in Love. Captain Corelli's Mandolin stars Nicolas Cage as a World War II Italian officer who falls in love with Penelope Cruz, a Greek villager. It is cheesy, it is bloated, and it has some questionable accents from most everyone involved, but it nonetheless has its moments, including beautiful cinematography and some sound Cage acting. The man is for sure passionate about mandolins, as disclosed by the title. You may not buy the romance between Cage and Cruz, but you will likely to enjoy other parts of the film."
  },
  {
    "ranking": 65,
    "tier": 4,
  ...
  },
  {
    ...
    "year": null,
    "description": "In Bangkok Dangerous, Nicolas Cage plays an experienced hitman who usually never socializes more than required on missions and hires small-time criminals for assistance before disposing of them. Of course, he struggles with the mission depicted in the film because he does things like date a local deaf-mute pharmacist and mentor his pickpocket assistant. This remake of the Pang Brothers' Thai film of the same name is a straightforward action movie that requires little attention to modestly enjoy, though it is a bit difficult to believe Cage wandering around with a quasi-mullet as a conspicuous hitman in Bangkok."
  },
  {
    "ranking": 73,
    "tier": 5,
  ...
  },
  {
    ...
    "title": "8mm",
    "year": null,
    "description": "In 8mm, Nicolas Cage plays a private investigator who ends up deep in the world of snuff films. The uncomfortable subject matter makes this a hard watch, and the screenplay does not help. At its core, it is a run-of-the-mill detective movie with added shock value and a solid Cage performance."
  },
  {
    "ranking": 77,
    "tier": 5,
  ...
  },
  {
    ...
    "title": "Ghost Rider",
    "year": null,
    "description": "Nicolas Cage loves comic books and superheroes. His choice of stage name was partially inspired by superhero Luke Cage. He was set to play Superman in Tim Burton’s cancelled Superman film in the 1990s. His son is named Kal-El. Nicolas Cage deserves to be in a better comic book franchise than Ghost Rider. The first Ghost Rider film does have entertaining and Cage-y moments, but all in all, this movie is mostly show and little substance. If you are a Cage fan or a Marvel fan, there are worse things you could do with a rainy afternoon. But fingers crossed Cage’s upcoming outing in Spider-Man Noir is more enjoyable."
  },
  {
    "ranking": 82,
    "tier": 5,
  ...
  },
  {
    ...
    "year": 1995,
    "description": "If you ever feel like next year might really be your year: In 1995, Nicolas Cage starred in Leaving Las Vegas and won the Academy Award for Best Actor, but the year before, he was in a shockingly dull Christmas-themed comedy/crime/action film. Cage plays a restaurant manager who helps his recently paroled brothers rob a bank, followed by your classic snowy small-town antics and the convenient (yet unbelievable) happenstance required to move the story along. At times, stretches of dialog will be painful enough that you will forget that this was written as a comedy. It is not in the bottom tier simply because Cage tries his best to make this one at least interesting, despite everyone else providing little of value."
  },
  {
    "ranking": 86,
    "tier": 5,
  ...
  },
  {
    ...
    "title": "The Old Way",
    "year": null,
    "description": "This ranking might be more disappointment than anything else. When I heard Nicolas Cage was going to be in a Western, you could not sign me up quickly enough! Unfortunately, this movie is derivative and predictable, with Cage being cabined to typical tropes and not being allowed to flesh out the character as well as he could. At the end of the day, if you need a Cage fix, this is an inoffensive Western about a retired outlaw hunting the men who killed his wife."
  },
  {
    "ranking": 88,
    "tier": 6,
    "tier_description": "For Cage Completionists Only",
    "title": "Stolen",
    "year": null,
    "description": "“12 Hours. $10 Million. 1 Kidnapped Daughter.” Reuniting with the director of Con Air, Nicolas Cage stars in a movie that was definitely not “Stolen” from any other popular movie from around that time. This Taken-ripoff features Cage as a thief recently released from prison who must rescue his kidnapped daughter from his former heist partner. It is a run-of-the-mill action movie with Cage doing little to make it more interesting."
  },
  {
    "ranking": 89,
    "tier": 6,
